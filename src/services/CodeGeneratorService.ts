...
`;
    ...
    private generateAsyncMethods(connection: ExternalConnection, className: string): string {
        return `
    /**
...
`;
        ...
        for (const endpoint of connection.endpoints) {
            ...
            if (endpoint.requestBody) {
                wrapperContent += this.generateWrapperClass(
                    `${endpointClassName}Request`,
    ...
    private generateWrapperClass(name: string, schema: SchemaDefinition): string {
        let content = `
    /**
     * ${name} wrapper class
     */
...
`;
    ...
    private generateMockClass(connection: ExternalConnection, className: string): GeneratedFile {
...
public class ${mockClassName} implements HttpCalloutMock {
    ...
    async generateNamedCredential(connection: ExternalConnection): Promise<GeneratedFile> {
...
<NamedCredential xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    async generateExternalService(connection: ExternalConnection): Promise<GeneratedFile[]> {
        const files: GeneratedFile[] = [];
        ...
        const openAPIService = await import('./OpenAPIImportService');
...
<ExternalServiceRegistration xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    private generateMetaXml(className: string, apiVersion: string): GeneratedFile {
...
<ApexClass xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    async writeGeneratedFile(file: GeneratedFile): Promise<void> {
    ...
    private convertToApexType(type: DataType, prop?: PropertyDefinition): string {
