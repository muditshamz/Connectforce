...
import { ExternalConnection, ERPTemplate } from '../types';

export class IntegrationBuilderPanel {
    public static currentPanel: IntegrationBuilderPanel | undefined;
    ...
    private currentConnection?: ExternalConnection;
    private template?: ERPTemplate;
    ...
    public static createOrShow(
        ...
        IntegrationBuilderPanel.currentPanel = new IntegrationBuilderPanel(
            panel, extensionUri, connectionService, salesforceService, logger, template
        );
    }
    ...
    public loadTemplate(template: ERPTemplate) {
        this.template = template;
    ...
    private async _testConnection(data: any) {
        try {
            const testConn: ExternalConnection = {
    ...
    private async _addEndpoint(data: any) {
        if (!this.currentConnection) {
