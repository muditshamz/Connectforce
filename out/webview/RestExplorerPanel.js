...
exports.RestExplorerPanel = void 0;
const vscode = __importStar(require("vscode"));
const child_process_1 = require("child_process");
const util_1 = require("util");
const execAsync = (0, util_1.promisify)(child_process_1.exec);
class RestExplorerPanel {
    static createOrShow(extensionUri, logger) {
        ...
        const panel = vscode.window.createWebviewPanel('restExplorer', 'Connectforce REST Explorer', column || vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
    ...
    async _getObjectFields(objectName) {
...
exports.RestExplorerPanel = RestExplorerPanel;
//# sourceMappingURL=RestExplorerPanel.js.map